...
//require'fun.php';
include'fun.php';
class SpecialIndoorAction extends Action
{
	...
	public function search(){
		...
		if($recoverName != NULL || $recoverName != '')
		{
			$wherequery .= " and isRecover = '".$recoverName."'";	
		}

		$Special = M("specialindoor");
