    ...
    .factory('appUrlService', function() {
        ...
        return {
            ...
            getDtUrlHost2: function () {
                return (window.location.hostname === '119.145.142.74') ? 'http://219.128.254.38:2868/' : 'http://10.17.165.100:2868/';
            },
            ...
            getInterferenceHost: function () {
                return (window.location.hostname === '119.145.142.74') ? 'http://219.128.254.36:8004/' : 'http://10.17.165.111:8004/';
            },
            getCustomerHost: function () {
                return (window.location.hostname === '119.145.142.74') ? 'http://219.128.254.38:8099/' : 'http://10.17.165.100:8099/';
            },
            getPhpHost: function () {
                return (window.location.hostname === '119.145.142.74') ? 'http://119.145.142.74:8106/' : 'http://132.110.71.122:9000/';
            },
            getPhpLocalhost: function () {
                return 'http://119.145.142.74:8106/';
            },
