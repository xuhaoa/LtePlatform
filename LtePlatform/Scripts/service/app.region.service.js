    ...
    .factory('downSwitchService', function (generalHttpService, appUrlService) {
        return {
            ...
            getStationsByAreaName: function(areaName, page, pageSize) {
                ...
                return generalHttpService.getMvcData(appUrlService.getPhpLocalhost() + 'LtePlatForm/lte/index.php/Station/search/', {
                curr_page: page,
                    page_size: pageSize,
                    areaName: areaName
                });
            ...
            getFixingStationById: function (id) {
                //return generalHttpService.getMvcData(appUrlService.getPhpHost() + 'LtePlatForm/lte/index.php/Station/search/', {
                return generalHttpService.postPhpUrlData(appUrlService.getPhpLocalhost() + 'LtePlatForm/lte/index.php/Fixing/single/', {
                    "id": id
                });
            },
